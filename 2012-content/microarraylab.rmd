...
Now explore the data set!  Here are some ideas:

*  Find genes which showed expression level changes > 2x between the 0’ time point and the experimental time point you chose.
*  Produce a [hierarchical cluster](http://en.wikipedia.org/wiki/Hierarchical_clustering) like the "phasograms" you saw in this week's malaria paper.  As you may have already noticed, you can use the `heatmap` function to do this!
