---
title: "R 101"
description: A practical introduction to working with data in R, including working with variables, functions and importing data.  Everything you need to know how to do in R to avoid ever having to use Exel again!
section: Background
data: 
  - data/codons.txt
  - data/npl3-dna.txt
...
* Read the DNA sequence in the file "data/dna.txt"
